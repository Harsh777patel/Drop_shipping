...
import { CheckCircle, ShieldCheck, Truck, DollarSign, Home, Box, MapPin } from "lucide-react";
...
function CheckoutContent({ params }) {
  ...
  return (
    <div className="min-h-screen w-full relative pt-24 px-4 pb-20 max-w-5xl mx-auto flex flex-col pt-32">
